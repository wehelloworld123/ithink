 ...
 */
public class ProDatacountExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andDataCountLike(Integer value) {
            addCriterion("data_count like", value, "dataCount");
            return (Criteria) this;
        }

        public Criteria andDataCountNotLike(Integer value) {
        ...
        public Criteria andDataTypeNotBetween(String value1, String value2) {
		 ...
		 public Criteria andLikeQuery(ProDatacount record) {
			...
			if(record.getDataCount()!=null&&StrUtil.isNotEmpty(record.getDataCount().toString())) {
    			 list.add("ifnull(data_count,'')");
    		}
			if(record.getDataType()!=null&&StrUtil.isNotEmpty(record.getDataType().toString())) {
    			 list.add("ifnull(data_type,'')");
    		}
			if(record.getId()!=null&&StrUtil.isNotEmpty(record.getId().toString())) {
    			list2.add("'%"+record.getId()+"%'");
    		}
			if(record.getDataCount()!=null&&StrUtil.isNotEmpty(record.getDataCount().toString())) {
    			list2.add("'%"+record.getDataCount()+"%'");
    		}
			if(record.getDataType()!=null&&StrUtil.isNotEmpty(record.getDataType().toString())) {
