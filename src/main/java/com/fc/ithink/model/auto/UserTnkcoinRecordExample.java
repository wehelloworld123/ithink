...
/**
 * 充值记录 UserTnkcoinRecordExample
 * @author xy_自动生成
 * @date 2021-05-27 13:57:17
 */
public class UserTnkcoinRecordExample {
    ...
    public UserTnkcoinRecordExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andBinTypIsNull() {
            addCriterion("bin_typ is null");
            return (Criteria) this;
        }

        public Criteria andBinTypIsNotNull() {
            addCriterion("bin_typ is not null");
            return (Criteria) this;
        }

        public Criteria andBinTypEqualTo(String value) {
            addCriterion("bin_typ =", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypNotEqualTo(String value) {
            addCriterion("bin_typ <>", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypGreaterThan(String value) {
            addCriterion("bin_typ >", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypGreaterThanOrEqualTo(String value) {
            addCriterion("bin_typ >=", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypLessThan(String value) {
            addCriterion("bin_typ <", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypLessThanOrEqualTo(String value) {
            addCriterion("bin_typ <=", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypLike(String value) {
            addCriterion("bin_typ like", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypNotLike(String value) {
            addCriterion("bin_typ not like", value, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypIn(List<String> values) {
            addCriterion("bin_typ in", values, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypNotIn(List<String> values) {
            addCriterion("bin_typ not in", values, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypBetween(String value1, String value2) {
            addCriterion("bin_typ between", value1, value2, "binTyp");
            return (Criteria) this;
        }

        public Criteria andBinTypNotBetween(String value1, String value2) {
            addCriterion("bin_typ not between", value1, value2, "binTyp");
            return (Criteria) this;
        }
        ...
        public Criteria andIsDelNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(UserTnkcoinRecord record) {
			...
			if(record.getReason()!=null&&StrUtil.isNotEmpty(record.getReason().toString())) {
    			 list.add("ifnull(reason,'')");
    		}
			if(record.getRemark()!=null&&StrUtil.isNotEmpty(record.getRemark().toString())) {
    			 list.add("ifnull(remark,'')");
    		}
			if(record.getBinTyp()!=null&&StrUtil.isNotEmpty(record.getBinTyp().toString())) {
    			 list.add("ifnull(bin_typ,'')");
    		}
			...
			if(record.getReason()!=null&&StrUtil.isNotEmpty(record.getReason().toString())) {
    			list2.add("'%"+record.getReason()+"%'");
    		}
			if(record.getRemark()!=null&&StrUtil.isNotEmpty(record.getRemark().toString())) {
    			list2.add("'%"+record.getRemark()+"%'");
    		}
			if(record.getBinTyp()!=null&&StrUtil.isNotEmpty(record.getBinTyp().toString())) {
    			list2.add("'%"+record.getBinTyp()+"%'");
    		}
			if(record.getCreateBy()!=null&&StrUtil.isNotEmpty(record.getCreateBy().toString())) {
