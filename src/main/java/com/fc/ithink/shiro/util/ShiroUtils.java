package com.fc.ithink.shiro.util;
...
import com.fc.ithink.util.BeanUtils;
...
public class ShiroUtils {
    ...
    public static String md5(String credentials, String saltSource,int hashIteration) {
        ByteSource salt = new Md5Hash(saltSource);
        return new SimpleHash(hashAlgorithmName, credentials, salt, hashIteration).toString();
    }
