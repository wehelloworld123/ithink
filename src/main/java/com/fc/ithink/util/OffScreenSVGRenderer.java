...
public class OffScreenSVGRenderer {
    ...
    public static BufferedImage renderToImage(SVGDocument document, int width, int height){
        return renderToImage(document, width, height, false);
    }

    public static void replaceFill(SVGDocument document, String idRegex, Color color){
